...
package com.slokam.test.automation.common.selenium;
...
public class SafeActions extends Sync
{
	...
	public void safeClick(By locator, int... optionWaitTime)
	{
		try
		{
			...
			if(waitUntilClickable(locator, waitTime))
			{
				...
				element.click();	
				//report.info("Clicked on element ::"+locator);
	...
	*/
	...
	public void safeSelectCountry(String value){
		driver.findElement(By.xpath("//div[@name='country']//div[@role='listbox']//span[text()='"+value+"']")).click();
	}
